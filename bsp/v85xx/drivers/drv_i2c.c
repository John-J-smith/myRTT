...
#define  IO_I2C_SCL_PORT            GPIOC
#define  IO_I2C_SCL_PIN             GPIO_Pin_13
#define  IO_I2C_SCL_INPUT           GPIOBToF_Init(IO_I2C_SCL_PORT, &(GPIO_InitType){IO_I2C_SCL_PIN, GPIO_Mode_INPUT})
#define  IO_I2C_SCL_OUTPUT          GPIOBToF_Init(IO_I2C_SCL_PORT, &(GPIO_InitType){IO_I2C_SCL_PIN, GPIO_Mode_OUTPUT_CMOS})
#define  IO_I2C_SCL_H               GPIOBToF_SetBits(IO_I2C_SCL_PORT, IO_I2C_SCL_PIN)
#define  IO_I2C_SCL_L               GPIOBToF_ResetBits(IO_I2C_SCL_PORT, IO_I2C_SCL_PIN)
#define  IO_I2C_SCL_PV              GPIOBToF_ReadInputDataBit(IO_I2C_SCL_PORT, IO_I2C_SCL_PIN)

#define  IO_I2C_SDA_PORT            GPIOC
#define  IO_I2C_SDA_PIN             GPIO_Pin_14
#define  IO_I2C_SDA_INPUT           GPIOBToF_Init(IO_I2C_SDA_PORT, &(GPIO_InitType){IO_I2C_SDA_PIN, GPIO_Mode_INPUT})
#define  IO_I2C_SDA_OUTPUT          GPIOBToF_Init(IO_I2C_SDA_PORT, &(GPIO_InitType){IO_I2C_SDA_PIN, GPIO_Mode_OUTPUT_CMOS})
#define  IO_I2C_SDA_H               GPIOBToF_SetBits(IO_I2C_SDA_PORT, IO_I2C_SDA_PIN)
#define  IO_I2C_SDA_L               GPIOBToF_ResetBits(IO_I2C_SDA_PORT, IO_I2C_SDA_PIN)
#define  IO_I2C_SDA_PV              GPIOBToF_ReadInputDataBit(IO_I2C_SDA_PORT, IO_I2C_SDA_PIN)
